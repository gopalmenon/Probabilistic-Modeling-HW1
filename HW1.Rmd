...
&= -E\left[ \left(\frac{\partial^2}{\partial\lambda^2} \ln  \frac{\lambda^xe^{-\lambda}}{x!}  \right )^2 \right]\\
&= -E\left[ \left(\frac{\partial^2}{\partial\lambda^2} \left ( x \ln \lambda - \lambda - \ln x! \right)  \right )^2 \right]\\
&= E\left[ \frac{\partial}{\partial\lambda}\left( \frac{x}{\lambda} - 1   \right )^2 \right]\\
